              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border">
                  {diagnosticos.map((d) => {
                    ...
                    const dataExibida = d.dataInspecao
                    ...
                    return (
                      <tr key={d.id} className="hover:bg-surface transition-colors">
                        <td className="px-4 py-3 text-xs text-gray-500 whitespace-nowrap">{dataExibida}</td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3 flex items-center gap-3">
                          <a href={`/equipamentos/${id}/diagnosticos/${d.id}`} className="text-xs font-semibold text-primary hover:underline">
                            Relatório
                          </a>
                          <a href={`/equipamentos/${id}/diagnosticos/${d.id}/pdf`} target="_blank" className="text-xs text-gray-400 hover:text-primary hover:underline">
                            PDF
                          </a>
                        </td>
                      </tr>
                      ...
                      {[...diagnosticos].reverse().map((d) => {
                        ...
                        return (
                          <th key={d.id} className="text-center px-4 py-2.5 font-semibold text-gray-600">
                            <a href={`/equipamentos/${id}/diagnosticos/${d.id}`} className="hover:underline">
                              {dataExibida}
                            </a>
                            <br />
