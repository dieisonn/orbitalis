...
export class ConfiguracaoEmpresaController {
  ...
  upsert(@Body() body: { nomeEmpresa?: string; nomeFantasia?: string; logoUrl?: string; corPrimaria?: string; cnpj?: string; telefone?: string; endereco?: string; responsavelTecnicoId?: string | null; mttrLimiteHoras?: number | null; mtbfLimiteDias?: number | null }) {
